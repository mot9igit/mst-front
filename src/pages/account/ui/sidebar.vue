  ...
  <aside class="sidebar" id="sidebar" :class="{ 'sidebar--full': !active }">
    <div class="sidebar__inner sidebar__inner--desktop">
      <div class="sidebar__content-wrapper">
        <div class="sidebar__logo-wrapper">
          <a href="/" class="sidebar__logo-container">
            ...
            <span class="sidebar__logo-text"><span class="sidebar__logo-text sidebar__logo-text--bold"
										>МС:</span>Управление продажами и закупками</span>
          </a>
        ...
        <div class="sidebar__content">
							...
							<!-- <div
								class="sidebar__divider sidebar__divider--light sidebar__toggle-divider sidebar__hidden"
							></div> -->

							<!-- <div class="sidebar__warehouse sidebar__hidden">
								<div class="sidebar__warehouse-content">
									<span class="sidebar__warehouse-title">Склад доставки:</span>
									<p class="sidebar__warehouse-text">
										Ростов на Дону, ул. Микухина Каланахлоя, 11 / 7 к 32 ЛИТ 898
									</p>
								</div>
								<button class="d-icon-wrapper sidebar__warehouse-button">
									<i class="d-icon-pen sidebar__warehouse-button-icon"></i>
								</button>
							</div> -->

							<!-- <div
								class="sidebar__divider sidebar__divider--light sidebar__warehouse-divider-bottom sidebar__hidden"
							></div> -->
							...
							<!-- <div
								class="sidebar__divider sidebar__divider--light sidebar__organization-divider-top sidebar__hidden"
							></div> -->
							...
							<div class="sidebar__info">
								...
								<div class="sidebar__block sidebar__organization-block hidden">
									<button
									...
									>
										...
										<div class="sidebar__organization-content">
											<span class="sidebar__organization-title"
											...
											>
												<i
													class="d-icon-refresh sidebar__organization-button-icon"
												></i>
												<span class="sidebar__organization-button-text"
													>Сменить компанию</span
												>
											</button>
										</div>
										<button
										...
										>
											<i
												class="d-icon-info sidebar__organization-info-button-icon"
											></i>
										</button>
									</div>
								</div>
								...
								<div
									class="sidebar__divider sidebar__divider--light sidebar__user-divider--bottom sidebar__hidden"
								></div>
							</div>
								...
								<ul class="sidebar__list">
									...
									>
										<button class="sidebar__item-button">
											...
											<i
												class="d-icon-angle-rounded-bottom sidebar__item-dropdown"
											></i>
										</button>
                          ...
                          <i
                            class="d-icon-doc sidebar__item-list-item-icon"
                          ></i>
                          Оптовый каталог
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-cart sidebar__item-list-item-icon"
                          ></i>
                          Мои заказы
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-cube sidebar__item-list-item-icon"
                          ></i>
                          Мои поставщики
                        </a>
											</li>
                          ...
                          Оптовые цены
											...
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-people sidebar__item-list-item-icon"
                          ></i>
                          Клиенты
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-truck sidebar__item-list-item-icon"
                          ></i>
                          Отгрузки
                        </a>
											</li>
                  ...
                  >
                          ...
                          Заказы
											...
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-percent-rounded sidebar__item-list-item-icon"
                          ></i>
                          Акции
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-wallet sidebar__item-list-item-icon"
                          ></i>
                          Баланс
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-shuffle sidebar__item-list-item-icon"
                          ></i>
                  ...
                  >
										...
										<ul class="sidebar__item-list">
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-line-chart sidebar__item-list-item-icon"
                          ></i>
                          Анализ склада
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-layers sidebar__item-list-item-icon"
                          ></i>
                          Коллекции товара
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-conveyor sidebar__item-list-item-icon"
                          ></i>
                          Настройки склада
                        </a>
											</li>
                  ...
                  >
										...
										<ul class="sidebar__item-list">
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-focus sidebar__item-list-item-icon"
                          ></i>
                          Карточка компании
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-user sidebar__item-list-item-icon"
                          ></i>
                          Сотрудники
                        </a>
											</li>
											<li class="sidebar__item-list-item">
												<a href="/" class="sidebar__item-list-item-content">
                          <i
                            class="d-icon-lock-open sidebar__item-list-item-icon"
                          ></i>
                          Политики доступа
                        </a>
											</li>
							...
							<div
								class="sidebar__divider sidebar__bottom-divider sidebar__visible"
							></div>
						</div>
      </div>
      <div class="sidebar__bottom">
						...
						<div
							class="sidebar__block sidebar__item sidebar__exit-block sidebar__exit-block--mini"
						>
							<button class="sidebar__item-button sidebar__exit">
						...
						<button
							class="sidebar__bottom-block sidebar__question-block sidebar__hidden"
						>
							<i class="d-icon-faq sidebar__bottom-block-icon"></i>
							<span class="sidebar__bottom-block-text">Работа в Закупках</span>
						</button>

						<button class="sidebar__bottom-block sidebar__exit-block sidebar__hidden">
