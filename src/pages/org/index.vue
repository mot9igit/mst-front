  ...
  <section class="lk-about" id="lk-about">
    ...
    <div v-else>
      ...
      >
        ...
        <div
          class="d-radio__wrapper lk-about__block-radio-wrapper"
          v-if="requisit.marketplace == '1'"
        >
          <label for="forMarketplace" class="p-checkbox p-component">
            <div
              class="p-checkbox p-component p-checkbox-checked"
            ...
            >
              <input
                ...
                value="1"
              />
              <div class="p-checkbox-box" data-pc-section="box" data-p="checked">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
                ...
                >
                  <path
                    d="M4.86199 11.5948C4.78717 11.5923 4.71366 11.5745 4.64596 11.5426C4.57826 11.5107 4.51779 11.4652 4.46827
...
.lk-about__block-radio-wrapper
  ...
  .p-checkbox-box,
.lk-about__block-radio-wrapper .p-checkbox-checked .p-checkbox-box,
.lk-about__block-radio .p-checkbox-checked .p-checkbox-box,
.lk-about__block-radio
  .p-checkbox-checked:not(.p-disabled):has(.p-checkbox-input:hover)
  .p-checkbox-box {
