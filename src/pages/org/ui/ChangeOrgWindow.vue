<template>
  <div class="d-modal2 d-modal2--active change-organization__modal">
      ...
      <div class="change-organization__item change-organization__item--big">
        ...
        <div class="change-organization__item-header">
          <div class="change-organization__item-image-container">
            <img src="/icons/logo.svg" alt="" class="change-organization__item-image" />
          </div>
          <p class="change-organization__item-title">МСТ</p>
        ...
        <div class="change-organization__item-content">
          <div class="change-organization__item-data">
            ...
            <p class="change-organization__item-data-text">г. Екатеринбург, ул. Предельная, 57/3</p>
          </div>
        </div>
      </div>
    </div>
    <div class="d-modal2__content change-organization__modal-content">
      <!-- Список организаций -->
      <div class="change-organization__item-list">
        <!-- Карточка организации -->
        <div class="change-organization__item">
          <!-- Верхушка -->
          <div class="change-organization__item-header">
            <div class="change-organization__item-image-container">
              <div class="change-organization__item-image-fallback"></div>
            </div>
            <p class="change-organization__item-title">МСТ</p>
          </div>
          <!-- Контент -->
