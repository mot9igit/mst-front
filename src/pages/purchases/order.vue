  ...
  <div class="d-top-order-container-info">
      ...
      <div class="order-card__orderinfo">
        <div class="order-card__orderinfo-grid">
          ...
          <div class="order-card__orderinfo-grid-text">{{ this.order.seller_name }}
                                                      </div>
        </div>
        <div class="order-card__orderinfo-grid">
        ...
        <div class="order-card__orderinfo-grid">
          ...
          <div class="order-card__orderinfo-grid-text">{{ this.order?.ur_persone?.name }}, ИНН:{{ this.order?.ur_persone?.inn }}</div>
        </div>
        <div class="order-card__orderinfo-grid">
        ...
        <div class="order-card__orderinfo-grid">
          ...
          <div class="order-card__orderinfo-grid-text">{{ this.order.day_delivery }} дн. ({{ this.order.delivery_date }})</div>
        </div>
      </div>
