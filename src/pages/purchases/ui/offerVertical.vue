...
.product-card__vertical .product-card__seller,
.product-card__vertical .product-card__seller--active-header {
  min-height: 26px;
}
...
.product-card__vertical .product-card__count:before,
.product-card__vertical .product-card__count:after {
  display: none;
}
...
.product-card__vertical .product-card .product-card__basket-button .d-counter,
.product-card__vertical .product-card__basket-button:not(.basket-true) form {
  display: flex;
}
...
.product-card-actions__modal-all .product-card__p,
.product-card-actions__modal-all .product-card__count-value,
.product-card-actions__modal-all .product-card__count-label {
  font-weight: 500;
  font-size: 16px;
  line-height: 21px;
  text-align: right;
...
.product-card-actions__modal-all .product-card__count:before,
.product-card-actions__modal-all .product-card__count:after {
  display: none;
}
...
.product-card-actions__modal-all .product-card .product-card__basket-button .d-counter,
.product-card-actions__modal-all .product-card__basket-button:not(.basket-true) form {
  display: flex;
}
.product-card-actions__modal-all .product-card__basket-button {
  display: flex;
...
@media (width <=1536px) {
  ...
  .product-card__vertical .product-card__count-value-require,
  ...
  .product-card__vertical .product-card__stat-name,
  .product-card__vertical .product-card__stat-description {
    font-size: 10px;
  }
  .product-card__vertical .product-card__count {
  ...
  .product-card-actions__modal-all .product-card__stat-name,
  .product-card-actions__modal-all .product-card__stat-description {
    font-size: 10px;
  }
  ...
  .product-card-actions__modal-all-item-href a,
...
@media (width <= 890px) {
  ...
  .product-card-actions__modal-all .product-card__buy-icon,
  .product-card-actions__modal-all-content .product-card__seller-button,
  .product-card__seller-button {
    display: flex !important;
  }
  .product-card__vertical .product-card-noactive {
...
@media (width <=800px) {
  ...
  .product-card__stat-list::after,
  .product-card__stat-list::before {
    display: none;
  }
...
@media (width <=700px) {
  ...
  .product-card-actions__modal-all-content .d-switch {
    --d-switch-width: 26px;
...
@media (width <=600px) {
  ...
  .product-card-actions__modal-all-content .product-card__stat-list-cont {
    grid-area: E;
    width: 100%;
    border-top: 0.5px solid #ededed79;
    border-bottom: 0.5px solid #ededed79;
    padding-bottom: 16px;
  }
  .product-card-actions__modal-all-content .product-card-actions__modal-all-item-href {
    grid-area: G;
