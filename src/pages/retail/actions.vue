  ...
  <div class = "retail__sales">
    ...
    <div v-else>
      ...
      <table class="d-table">
        ...
        <tbody class="d-table__body"><!-- v-if="sales.total != 0">-->
...
.retail__sales-top .p-floatlabel:has(input:focus) label, .retail__sales-top .p-floatlabel:has(input:-webkit-autofill) label,
.retail__sales-top  .p-floatlabel:has(textarea:focus) label,.retail__sales-top  .p-floatlabel:has(.p-inputwrapper-focus) label {
  color: #f92c0d;
}
.retail__sales-top .d-table__col,.retail__sales-top  .d-table__row:first-child > .d-table__col {
  padding: 16px;
}
