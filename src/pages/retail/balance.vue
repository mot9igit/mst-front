<template>
  <section class="shipments balance" id="shipments">
      ...
      <div class="balance-info__container">
        <div class="balance-info__button-wrapper">
          <div class="balance-info__value-container">
            ...
            <div class="balance-info__value">
              {{ orgActive.balance != '' ? orgActive.balance : '0' }} ₽
            </div>
            <button
              type="button"
              href="#"
        ...
        <div class="balance-info__info-wrapper">
          ...
          <ul class="balance-info">
            ...
            <li class="balance-info__item">
              ...
              <p class="balance-info__text">
                Получите в течение <span style="color: #f92c0d">трех рабочих дней</span> выплату
                средств за реализованные товары за вычетом комиссии.
              </p>
            </li>
          </ul>
        </div>
      ...
      <div class="balance-info__value-container">
        ...
        >
          ...
          <div v-if="v$.form.summEntered.$error" class="d-input-error">
            ...
            <span class="d-input-error__text">Введите корректную сумму для вывода!</span>
          </div>
          <div class="message d-input-error" v-if="errorMessage">
            <i class="d-icon-warning d-input-error__icon"></i
            ><span class="d-input-error__text">Вы ввели не корректную сумму для вывода!</span>
          </div>
...
@media (width <= 1024px) {
  ...
  .balance__main .d-table__head-col,
  .balance__main .d-table__col {
    font-size: 12px;
    font-weight: 400;
    position: relative;
  }
