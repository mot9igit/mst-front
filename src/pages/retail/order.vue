<template>
  ...
  <div class="d-top-order-container-left">
    ...
    <div class="d-badge2 d-badge2--fit d-button--sm-shadow order-card__status" :style="
          'background-color: #' +
          order.order.status_color
        "
      >
        {{ order.order.status_name }}</div>
