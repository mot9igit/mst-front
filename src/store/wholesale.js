...
export default {
  ...
  actions: {
    ...
    async getOrder({ commit }, { order_id, page, perpage }) {
      const data = {
        action: 'get/orders/seller',
        id: router.currentRoute._value.params.id,
        order_id: order_id,
    ...
    async optOrderCancel(store, { order_id }) {
      const data = {
        action: 'order/opt/seller/cancel',
        id: router.currentRoute._value.params.id,
        order_id: order_id,
      }
    ...
    async editOptOrder(store, { order_id }) {
      const data = {
        action: 'order/opt/edit',
        id: router.currentRoute._value.params.id,
        order_id: order_id,
      }
      const response = await api.purchases.canselOptOrder(data)
